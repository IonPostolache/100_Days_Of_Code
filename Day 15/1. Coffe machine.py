...
#TODO 5: a. For maintainers of the coffee machine, they can use “off” as the secret word to turn off
# the machine. Your code should end execution when this happens.

#TODO 6: 3. Print report.

#TODO 7: a. When the user enters “report” to the prompt, a report should be generated that shows
...
#TODO 9: a. When the user chooses a drink, the program should check if there are enough
# resources to make that drink.
#TODO 10: b. E.g. if Latte requires 200ml water but there is only 100ml left in the machine. It should
# not continue to make the drink but print: “Sorry there is not enough water.”

#TODO 11: c. The same should happen if another resource is depleted, e.g. milk or coffee.

#TODO 12: 5. Process coins.
#TODO 13: a. If there are sufficient resources to make the drink selected, then the program should
...
#TODO 17: a. Check that the user has inserted enough money to purchase the drink they selected.
